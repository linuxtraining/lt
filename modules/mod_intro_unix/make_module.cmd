...
modfilename=mod_intro_unix.xml

# Sets the title of this module
modtitle="Introduction to Unix and Linux"
...
cat history_unix.xml   >> $modfilename
cat licensing.xml      >> $modfilename
cat distros.xml        >> $modfilename
cat certifications.xml >> $modfilename
